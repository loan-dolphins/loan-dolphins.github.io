        ...
        >
          ...
          <ParallaxLayer offset={1} speed={0}>
            ...
            <div className="flex justify-center opacity-50">
              This is where a quick explanation of the company will go,
              obviously not styled like this
            </div>
          </ParallaxLayer>
          ...
          >
            <h1 className="position absolute left-0 text-red-600 text-opacity-80">
              Evil Dolphin goes here
            </h1>
